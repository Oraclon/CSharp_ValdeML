...
//                //double[] selected_prevDers = previous_derivatives[i];
//                Span<double> selected_prevDers = previous_derivatives[i];
//                ref var prevDersSearchArea = ref MemoryMarshal.GetReference(selected_prevDers);
